"""SQLZOO: More JOIN Operations Solutions"""


"1. List the films where the year is 1962. Show id and title."
...
"3. List all of the Star Trek movies. Include the id, title, and year
